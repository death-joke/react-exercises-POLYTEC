...
function Child() {
    ...
    const element = (
      <>
          {console.log('%c    Child: rendering HTML JSX', 'color: MediumSpringGreen')}
...
function AppDemoFullLifeCycle() {
    ...
    const element = (
      <>
          {console.log('%cApp: rendering HTML JSX', 'color: MediumSpringGreen')}
          <label>
              <input
                type="checkbox"
                checked={showChild}
...
export default AppDemoFullLifeCycle;
